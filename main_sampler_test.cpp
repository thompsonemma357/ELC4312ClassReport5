...
void adt7420_check(I2cCore *adt7420_p, GpoCore *led_p, SsegCore *sseg_p) {
   ...
   for (int i = 0; i < len; i++) {
      ...
      if (current_char == '.') {
            ...
            // Convert character '0'-'9' to an integer/hex value 0x0-0x9
            int hex_val = (int)(current_char - '0'); 
            
            switch (hex_val) {
               case 0:
                  sseg_p->write_1ptn(0x40, display_pos);
               break;
               case 1:
                  sseg_p->write_1ptn(0x79, display_pos);
               break;
               case 2:
                  sseg_p->write_1ptn(0x24, display_pos);
               break;
               case 3:
                  sseg_p->write_1ptn(0x30, display_pos);
               break;
               case 4:
                  sseg_p->write_1ptn(0x19, display_pos);
               break;
               case 5:
                  sseg_p->write_1ptn(0x12, display_pos);
               break;
               case 6:
                  sseg_p->write_1ptn(0x02, display_pos);
               break;
               case 7:
                  sseg_p->write_1ptn(0x78, display_pos);
               break;
               case 8:
                  sseg_p->write_1ptn(0x00, display_pos);
               break;
               case 9:
                  sseg_p->write_1ptn(0x10, display_pos);
               break;
               default:
                  sseg_p->write_1ptn(0xFF, display_pos);
               break;
            }
            display_pos--;
       }
